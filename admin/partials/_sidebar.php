...
$ret = "SELECT * FROM  lms_admin  WHERE admin_id = '$admin_id'";
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="../admin/assets/img/brand/Library.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="dashboard.php">
                <img src="../admin/assets/img/brand/Library.png">
              </a>
            </div>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="books.php">
              <i class="ni ni-bullet-list-67 text-primary"></i>Books
            </a>
